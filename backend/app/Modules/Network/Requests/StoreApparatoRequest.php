...
class StoreApparatoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'tipo' => ['required', 'in:switch,router,ap,telecamera,nvr,fibra,altro'],
            ...
            'stato' => ['required', 'in:attivo,guasto,manutenzione'],
